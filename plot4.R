...
windows()
par(mfrow = c(2,2), mar = c(4,4,2,2), oma = c(1,1,2,1)) # set the quadrants in the plot

# Plot 1
with(data_sub, plot(Global_active_power ~ datetime, type = "l", xlab = "", ylab = "Global Active Power"))

#Plot 2
with(data_sub, plot(Voltage ~ datetime, type = "l", ylab = "Voltage"))
...
# Plot 4
with(data_sub, plot(Global_reactive_power ~ datetime, type = "l"))
